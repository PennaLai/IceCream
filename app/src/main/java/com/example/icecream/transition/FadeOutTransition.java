package com.example.icecream.transition;
...
public class FadeOutTransition extends AutoTransition {
  ...
  /**
   * Creates a AutoTransition that calls the {@linkplain
   * android.transition.Transition.TransitionListener#onTransitionEnd(Transition)} of the passing
